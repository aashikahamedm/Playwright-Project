...
Error: expect(page).toHaveScreenshot(expected) failed
  ...
  8904 pixels (ratio 0.01 of all image pixels) are different.

  Snapshot: landingpage.png

Call log:
  - Expect "toHaveScreenshot(landingpage.png)" with timeout 5000ms
...
> 43 |     await expect(page).toHaveScreenshot('landingpage.png', {
     |                        ^ Error: expect(page).toHaveScreenshot(expected) failed
  44 |         maxDiffPixels: 150
  45 |     });
  46 | })
  47 | 
  48 | 
