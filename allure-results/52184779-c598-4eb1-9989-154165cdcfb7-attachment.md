...
```
Error: A snapshot doesn't exist at C:\Users\Windows\Downloads\ISM\Playwright Automation\tests\MoreValidations.spec.js-snapshots\landingpage-chromium-win32.png, writing actual.
```
...
> 42 |     expect(await page.screenshot()).toMatchSnapshot('landingpage.png');
     |                                     ^ Error: A snapshot doesn't exist at C:\Users\Windows\Downloads\ISM\Playwright Automation\tests\MoreValidations.spec.js-snapshots\landingpage-chromium-win32.png, writing actual.
  43 | 
  44 | })
  45 | 
